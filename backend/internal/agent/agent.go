...
- ALWAYS state the result the code actually produced in your answer text, in a sentence outside the code block. The user should never have to expand the tool call to find out what it printed.
