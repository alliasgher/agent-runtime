    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          />
          {/* Drawer */}
          <div className="relative flex flex-col w-72 bg-slate-950 border-r border-slate-800 h-full">
      ...
      {/* ── Mobile trigger strip (always visible on small screens) ── */}
      <div className="flex md:hidden flex-col items-center w-12 border-r border-slate-800 bg-slate-950 py-4 gap-3">
        <button
      ...
      {/* ── Desktop sidebar ── */}
      {collapsed ? (
        <div className="hidden md:flex flex-col items-center w-12 border-r border-slate-800 bg-slate-950 py-4 gap-3">
          <button
        ...
        <div className="hidden md:flex flex-col w-60 flex-shrink-0 border-r border-slate-800 bg-slate-950">
          {headerButtons()}
          {sessionList}
        </div>
      )}
